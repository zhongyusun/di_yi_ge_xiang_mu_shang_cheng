    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('admin.role.edit',$role)}}">
                        <span class="hidden-sm-up"><i class="ti-user"></i></span> <span
                            class="hidden-xs-down">添加角色</span>
                    </a>
                </li>
            ...
            <div class="tab-content">
                ...
                <div class="card-body">
                    <form action="{{route('admin.role.update',$role)}}" method="post" class="form-horizontal ">
                    @csrf @method('PUT')
                    <!--/row-->
                        <div class="form-group row">
                            <label class="control-label text-right" style="margin-left: 20px">角色中文名称</label>
                            <div class="col-md-9">
                                <input type="text" placeholder="" name="title" value="{{$role['title']}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-right" style="margin-left: 50px">角色标识</label>
                            <div class="col-md-9">
                                <input type="text" placeholder="" name="name" value="{{$role['name']}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
