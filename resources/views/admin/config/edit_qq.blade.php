                    ...
                    <div class="card-body">
                        <form action="{{route('admin.config.update',['name'=>$name])}}" method="post"
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right" style="margin-left: 100px">QQ_KEY</label>
                                <div class="col-md-9">
                                    <input type="text" name="QQ_KEY" placeholder=""
                                           value="{{$config['data']['QQ_KEY']}}"
                                           class="form-control">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="control-label text-right" style="margin-left: 70px">QQ_SECRET</label>
                                <div class="col-md-9">
                                    <input type="text" name="QQ_SECRET"
                                           value="{{$config['data']['QQ_SECRET']}}"
