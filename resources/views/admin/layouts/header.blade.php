        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                ...
                <!-- Logo text --><span>
                    ...
                    <!-- Light Logo text -->
                         <img src="{{asset('org')}}/assets/images/logo-light-text.png" class="light-logo" alt="homepage"/></span> </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <div class="container"><img class="d-block img-fluid"
                                                                        src="{{asset('org')}}/assets/images/big/img1.jpg"
                                                                        alt="First slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                                        src="{{asset('org')}}/assets/images/big/img2.jpg"
                                                                        alt="Second slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                                        src="{{asset('org')}}/assets/images/big/img3.jpg"
                                                                        alt="Third slide"></div>
                                        </div>
                                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="message-center">
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"><img src="{{asset('org')}}/assets/images/users/1.jpg"
                                    ...
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"><img src="{{asset('org')}}/assets/images/users/2.jpg"
                                                                   alt="user" class="img-circle"> <span
                                    ...
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"><img src="{{asset('org')}}/assets/images/users/3.jpg"
                                                                   alt="user" class="img-circle"> <span
                                    ...
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"><img src="{{asset('org')}}/assets/images/users/4.jpg"
                                                                   alt="user" class="img-circle"> <span
