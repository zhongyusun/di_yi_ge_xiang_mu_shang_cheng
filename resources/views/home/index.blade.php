...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="{{asset('org')}}/css/amazeui.css" rel="stylesheet" type="text/css" />
		<link href="{{asset('org')}}/css/admin.css" rel="stylesheet" type="text/css" />

		<link href="{{asset('org')}}/css/demo.css" rel="stylesheet" type="text/css" />

		<link href="{{asset('org')}}/css/hmstyle.css" rel="stylesheet" type="text/css"/>
		<link href="{{asset('org')}}/css/skin.css" rel="stylesheet" type="text/css" />
		<script src="{{asset('org')}}/js/jquery.min.js"></script>
		<script src="{{asset('org')}}/js/amazeui.min.js"></script>
	...
	<body>
		...
		<script>
			window.jQuery || document.write('<script src="org/js/jquery.min.js "><\/script>');
		</script>
		<script type="text/javascript " src="{{asset('org')}}/js/quick_links.js "></script>
	</body>
