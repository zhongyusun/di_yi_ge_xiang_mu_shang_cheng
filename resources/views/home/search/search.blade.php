                        ...
                        <li>
                            <div class="lieb_neir_kuang lieb_neir_kuang_1">
                                <div class="lieb_img lieb_img_1">
                                    <a href="#"><img src="{{$good['list_pic']}}" height="100%"></a>
                                </div>
                                <div class="lieb_er_kuang">
                                    <div class="shangp_biaot_ shangp_biaot_1">
                                        <a href="#">{{$good->title}}</a>
                                        <p><a class="lianpu_minc" href="#">古竣服装专营店</a><a class="mis" href="#">点我交谈</a>
                                        </p>
                                    </div>
                                    <div class="lieb_text lieb_text_1">
                                        <div class="p_price">
                                            <strong class="J_price"><em>¥</em><i>{{$good->price}}</i>
                                                <p><em class="shangp_yuanj zuo_ji">¥</em><i
                                                        class="shangp_yuanj">{{$good->promotion}}</i>
                                                </p>
                                            </strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="btn-product"><a class="J_focus" onclick="send({{$good['id']}},{{$id}})" href='javascript:;'><i></i>加入购物车</a></div>
                                </div>
                            </div>
                        </li>
                    @endforeach
